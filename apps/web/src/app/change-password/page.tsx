...
export default function ChangePasswordPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100 dark:bg-gray-950 font-sans">
      <div className="w-full max-w-md p-8 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-100 dark:border-gray-800">
        <div className="text-center mb-2">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Change Your Password</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm">You are using the default password. Please set a new password before continuing.</p>
        </div>

        <div className="my-6 p-3 bg-amber-50 dark:bg-amber-950/50 text-amber-800 dark:text-amber-300 text-sm rounded-lg border border-amber-200 dark:border-amber-800">
